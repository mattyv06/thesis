\documentclass[dissertation]{MSUstyle}
...
% =============================== %
\name{Chris Jordan Doe} %PUT your FULL name here
\DocTitle{This is the title of your thesis or dissertation \newline which may span multiple lines} 
\OWNwebpage{http://mywebsite.net} %your personal webpage
\degreetitle{Engineering} % may be different than department... ie MS in Electrical Engineering is not Elect. and Com. Engnr degree.
...
\copyrightyear{2015} %add one to year if document submitted in Dec.
\draftver{1.0} %versioning for use with draft option

% put searchable words you want internet search engines to find here
\keys{Electrical Engineering, PhD, Dissertation, Template, Latex, Montana, Montana State} 
